...
from audio_chat.agent_core.multimodal.assets import asset_to_url, iter_result_assets
from audio_chat.agent_core.multimodal.builder import (
    build_image_block,
    build_tool_asset_followup_message,
    build_video_block,
)
from audio_chat.agent_core.multimodal.policy import MultimodalMessagePolicy
from audio_chat.agent_core.multimodal.video_sampling import video_sampling_not_available_reason


@dataclass(frozen=True)
class MessageUpdate:
    """Text provider message 更新结果。
