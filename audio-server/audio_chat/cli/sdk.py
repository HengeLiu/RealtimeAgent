...
def _endpoint_source_check(audio_root: Path) -> dict:
    ...
    required_files = {
        "ios_phone": [
            ...
            "examples/for-blind-app/devices/native-ios-phone/AudioChatPhone.xcodeproj/project.pbxproj",
        ...
        "python_phone_mock": [
            ...
            "examples/dev-support/devices/python-phone/audio_chat_python_phone_mock/__main__.py",
        ],
        "python_glass": [
...
def _source_boundary_check(audio_root: Path) -> dict:
    ...
    core_root = audio_root / "audio-server" / "audio_chat"
    ...
    for path in sorted(core_root.rglob("*.py")):
        ...
        for needle in ("audio_chat.endpoints", "examples.", "examples/for-blind-app/devices/native-ios-phone", "examples/for-blind-app/devices/native-esp32-glass"):
            if needle in text:
