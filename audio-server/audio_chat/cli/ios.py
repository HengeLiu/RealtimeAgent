...
def open_ios(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument("--project", default="examples/for-blind-app/devices/native-ios-phone/AudioChatPhone.xcodeproj", help="Xcode 工程路径")
    ...
    if sys.platform != "darwin":
        raise RuntimeError("audio-chat.ios.open 需要 macOS；无桌面环境请使用 --print-path 查看工程路径")
