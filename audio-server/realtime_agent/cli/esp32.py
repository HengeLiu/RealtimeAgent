...
def config(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument("--source", default="examples/for-blind-app/audio-server/config/generated/esp32-s3.local.env", help="源 env 文件")
    ...
    if not source.exists():
        raise FileNotFoundError(
            ...
            "请先运行 realtime-agent.config.sync --output-dir examples/for-blind-app/audio-server/config/generated"
        )
