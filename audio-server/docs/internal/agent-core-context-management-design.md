...
现状详见 `audio-server/docs/internal/agent-core-context-inventory.md`。
...
```bash
uv run python -m pytest audio-server/tests/test_agent_core_router.py -q
uv run python -m pytest audio-server/tests/test_realtime_audio_agent_core.py -q
uv run python -m pytest audio-server/tests/test_realtime_provider_tool_bridge.py -q
uv run python -m pytest audio-server/tests/test_memory_service.py -q
uv run python -m pytest audio-server/tests/test_conversation_memory_service.py -q
```
...
- 验证：`uv run python -m pytest audio-server/tests/test_context_prompt_registry.py -q` 通过。
...
- 验证：`uv run python -m pytest audio-server/tests/test_context_compiler.py -q` 通过。
...
- 验证：`uv run python -m pytest audio-server/tests/test_model_request_logging.py audio-server/tests/test_text_agent_tool_loop_async.py -q` 通过。
...
- 验证：`uv run python -m pytest audio-server/tests/test_realtime_audio_agent_core.py -q`、`uv run python -m pytest audio-server/tests/test_realtime_provider_tool_bridge.py -q` 通过。
...
```bash
uv run python -m pytest audio-server/tests/test_context_prompt_registry.py audio-server/tests/test_context_compiler.py -q
uv run python -m pytest audio-server/tests/test_agent_core_router.py::test_agent_mode_text_builds_text_core audio-server/tests/test_agent_core_router.py::test_agent_mode_realtime_audio_builds_realtime_core -q
uv run python -m pytest audio-server/tests/test_realtime_audio_agent_core.py -q
uv run python -m pytest audio-server/tests/test_realtime_provider_tool_bridge.py -q
uv run python -m pytest audio-server/tests/test_model_request_logging.py audio-server/tests/test_text_agent_tool_loop_async.py -q
uv run python -m pytest audio-server/tests/test_memory_service.py audio-server/tests/test_conversation_memory_service.py audio-server/tests/test_tool_spec_schema.py audio-server/tests/test_task_signal_bridge.py -q
uv run python -m pytest audio-server/tests/test_package_boundary.py -q
git diff --check
```
...
```bash
uv run python -m pytest audio-server/tests/test_release_package.py audio-server/tests/test_package_check_release_inputs.py -q
```
