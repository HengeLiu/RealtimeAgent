...
| Memory / Skill / MCP   | 已实现   | C 线路已落地 `MemoryService`、`SkillService`、`McpGateway` 和内置 Tool；由 `audio-server/tests/sdk/runtime/test_memory_service.py`、`audio-server/tests/sdk/extensions/test_skill_service.py`、`audio-server/tests/sdk/extensions/test_mcp_gateway.py`、`audio-server/tests/acceptance/test_indirect_device_context_contract.py` 覆盖。任何需要设备通讯能力的 Memory / Skill / MCP 都必须封装成 Tool 或 Task。 |
...
| 能力                        | 验收依据                                                                                                                                                                                                                       |
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| CLI 和开发者入口            | `audio-server/tests/cli/test_cli_developer_workflow.py`、`audio-server/tests/cli/test_docs_commands.py`                                                                                                                                                      |
