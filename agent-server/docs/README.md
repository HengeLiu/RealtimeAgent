...
本目录保存 server SDK 相关文档，面向需要理解或修改 `agent-server/realtime_agent` 的开发者。
...
- [Context 与设备 API 设计说明](reference/上下文设备接口设计.md)
...
- [Omni Realtime Manual Turn 生命周期设计](internal/OmniRealtimeManualTurn生命周期设计.md)
