...
本文是 `realtime-agent` 当前 Context 设备 API 的架构契约和设计说明。它用于固定公开 API、Context 分层、设备能力结构、selector 规则和 AssetRef 边界。它不是当前版本的开发操作手册；按当前代码开发设备和能力时，请阅读 [设备注册与功能开发说明](../how-to/设备能力开发说明.md)。
