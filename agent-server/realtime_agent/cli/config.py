...
def sync(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument("--app-root", default="examples/simple-agent-server", help="业务应用根目录")
    parser.add_argument("--server-config", default="examples/simple-agent-server/server.yaml", help="源 server YAML")
