...
def sync(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument("--app-root", default="examples/device_app_demo/agent-server", help="业务应用根目录")
    parser.add_argument("--server-config", default="examples/device_app_demo/agent-server/server.yaml", help="源 server YAML")
    ...
    report = {
        ...
        "files": {
            ...
            "ios_device_app_demo": str(ios_target),
