...
from realtime_agent.device_capabilities import compile_device_capabilities_file
...
def validate(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(prog="realtime-agent.device.validate", description="校验 realtime-agent 设备能力文件")
