...
```bash
uv run python -m pytest examples/for-blind-app/app-tests/endpoints/test_esp32_s3_endpoint_contract.py examples/for-blind-app/app-tests/config/test_endpoint_config_sync.py -q
```
