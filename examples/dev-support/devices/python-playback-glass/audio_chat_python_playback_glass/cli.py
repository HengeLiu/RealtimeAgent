...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(prog="python -m audio_chat_python_playback_glass")
    ...
    run_parser.add_argument("--runs-root", default="examples/for-blind-app/audio-server/runs")
