...
2. 新增一个“批量编排器”负责：
   ...
   - 拉取服务端会话调试快照
   - 落盘单条结果与批量汇总
3. 把核心逻辑放进 `openaiglass-sdk/server-python/devtools`，方便复用和单元测试。
...
1. [audio_sample_batch_runner.py](/Users/elio/dev/llm-project/OpenAIglassesDemo_2/openaiglass-sdk/server-python/devtools/audio_sample_batch_runner.py)
