...
1. [SDK 剩余高优先级能力补全工作计划](./stage2/plan/SDK剩余高优先级能力补全工作计划.md)
2. [全双工实时语音对话专项计划](./stage2/plan/全双工实时语音对话专项计划.md)
3. [全双工实时语音对话设计](./structure-design/全双工实时语音对话设计.md)
4. [全双工实时语音对话开发方案](./stage2/plan/全双工实时语音对话开发方案.md)
5. [全双工实时语音对话验收方案](./stage2/plan/全双工实时语音对话验收方案.md)

迭代记录：

1. [SDK v1 迭代记录](./stage2/iteration-v1.md)
2. [SDK v2 迭代记录](./stage2/iteration-v2.md)
3. [SDK v3-v16 迭代记录](./stage2/)
