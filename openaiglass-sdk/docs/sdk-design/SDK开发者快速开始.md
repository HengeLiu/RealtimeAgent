...
result = ScenarioRunner(sdk).run(
    Path("testdata/scenario/find_object_basic.json")
)
```
...
1. `server/main.py`
2. `capabilities/find_object/server/tool.py`
3. `capabilities/find_object/server/task.py`
4. `capabilities/find_object/phone/processor.py`
