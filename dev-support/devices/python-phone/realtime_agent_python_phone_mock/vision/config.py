...
class VisionConfig:
    ...
    device: str = "auto"
    frame_stride: int = 1
    save_annotated_frame: str = "runs/realtime-agent/python-phone/latest-yolo.jpg"
    ...
    def from_mapping(cls, value: dict[str, Any] | None) -> "VisionConfig":
        ...
        return cls(
            ...
            save_annotated_frame=str(raw.get("save_annotated_frame") or "runs/realtime-agent/python-phone/latest-yolo.jpg"),
