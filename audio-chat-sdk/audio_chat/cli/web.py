...
def open_web(argv: list[str] | None = None) -> None:
    ...
    主要逻辑：
    1. 默认解析仓库内 `device-examples/browser-glass/index.html`。
    ...
    parser.add_argument("--path", default="device-examples/browser-glass/index.html", help="browser-glass HTML 路径")
