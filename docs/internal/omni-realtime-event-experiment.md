...
```bash
examples/for-blind-app/audio-server/runs/user-browser-glass-001/dev-browser-glass-001/photos/asset_5c68b990ae0e.jpg
```
...
- 后续仍要在浏览器参考端和真实眼镜端验证连续多轮输入，确认图片不会串到下一轮 turn。
