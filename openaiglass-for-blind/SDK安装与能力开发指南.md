...
当前指南对应 SDK 版本：`sdk-v86`。本版本在 `sdk-v85` 连续 VAD 空段保护基础上，恢复真实 ESP32 的受限连续对话窗口，补齐“结束对话/安静”停止指令拦截和播放中唤醒词打断。公网/NAT 穿透、跨机器分布式任务平台、iOS 二进制 XCFramework 和 ESP32 component registry 发布暂不覆盖。
