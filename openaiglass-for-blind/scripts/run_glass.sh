...
PROJECT_DIR="${PROJECT_DIR:-${REPO_ROOT}/openaiglass-sdk/glass-esp32}"
TARGET="${TARGET:-esp32s3}"
BAUD_RATE="${BAUD_RATE:-115200}"
PORT="${PORT:-}"
BUILD_DIR="${BUILD_DIR:-${PROJECT_DIR}/build}"
LOCAL_CONFIG_FILE="${LOCAL_CONFIG_FILE:-${APP_ROOT}/host/glass/config/local_build.env}"
LOCAL_CONFIG_TEMPLATE="${LOCAL_CONFIG_TEMPLATE:-${APP_ROOT}/host/glass/config/local_build.env.example}"
