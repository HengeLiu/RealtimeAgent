...
LOCAL_CONFIG_FILE="${LOCAL_CONFIG_FILE:-${APP_ROOT}/glass/config/local_build.env}"
LOCAL_CONFIG_TEMPLATE="${LOCAL_CONFIG_TEMPLATE:-${APP_ROOT}/glass/config/local_build.env.example}"
