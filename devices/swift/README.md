...
Swift SDK 的当前实现设计以 [SWIFT_DEVICE_SDK_DESIGN.md](SWIFT_DEVICE_SDK_DESIGN.md)
...
`downstream.pause.requested`、`downstream.resume.requested`、`stream.output.finished` 和
