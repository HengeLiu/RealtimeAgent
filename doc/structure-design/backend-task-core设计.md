...
3. 具体的任务模板开发、Agent 协作和眼镜端执行器协作方式，详见 [backend-task-core开发指南.md](/Users/elio/dev/llm-project/OpenAIglassesDemo_2/doc/structure-design/backend-task-core开发指南.md)。
4. 通知优先级、抢占、合并、排队等细节不在本文档展开，统一放到单独通知协调文档。
