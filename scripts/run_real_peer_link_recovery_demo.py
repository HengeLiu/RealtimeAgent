...
def build_argument_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(description="启动真实场景任务级连接恢复 demo。")
    parser.add_argument("--server-port", type=int, default=18290)
    parser.add_argument("--glass-port", type=int, default=18291)
    parser.add_argument("--phone-port", type=int, default=18292)
...
def main() -> None:
    ...
    try:
        ...
        broken = post_json(
            f"{server_base_url}/tasks/{session_id}/peer-link/broken",
            {"runtime": "glass", "reason": "simulated_disconnect", "auto_recover": True},
        )
